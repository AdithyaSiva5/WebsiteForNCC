...
elseif($name=="nid" )
  {
	  ...
	  $result22 = mysqli_query($con,"select * from ncchead where id='$_SESSION[nid]'");
		$roww=mysqli_fetch_array($result22);
		$a=$roww['id'];
echo "<input type='text' readonly  name='$name'  value='$a' required class='form-control'>";
