...
$datas=$row2[$name];
//echo $datas;
 $result23 = mysqli_query($con,"select * from department where id='$row2[department]'");
$row11= mysqli_fetch_array($result23);
if($i==1 )
{
...
elseif($i==8)
  {
	  ...
	  $result22 = mysqli_query($con,"select * from department");

echo "<select name='$name' required class='form-control'>";
echo "<option value='$row11[id]'>$row11[department]</option>";

while ($row22 = mysqli_fetch_array($result22))
 {

echo "<option value='$row22[id]'>$row22[department]</option>";
