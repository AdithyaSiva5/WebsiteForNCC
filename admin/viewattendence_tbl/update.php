...
$datas=$row2[$name];
//echo $datas;
 $result23 = mysqli_query($con,"select * from stations where id='$row2[stationname]'");
...
elseif($i==10)
  {
	  ...
	  $result22 = mysqli_query($con,"select * from stations");

echo "<select name='$name' required class='form-control'>";
echo "<option value='$row11[id]'>$row11[stationname]</option>";

while ($row22 = mysqli_fetch_array($result22))
 {

echo "<option value='$row22[id]'>$row22[stationname]</option>";
